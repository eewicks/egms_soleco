    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f172a 100%); box-shadow: 0 8px 32px rgba(0, 0, 0, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.1); backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px);">
            ...
            <li class="nav-item" style="margin: 8px 16px;">
                <a class="nav-link" href="<?php echo e(route('admin.dashboardtest')); ?>" style="padding: 16px 20px; border-radius: 8px; background: transparent; border: none; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); color: rgba(255, 255, 255, 0.9); font-weight: 500;">
            ...
            <li class="nav-item" style="margin: 6px 16px;">
                <a class="nav-link" href="<?php echo e(route('devices.index')); ?>" style="padding: 16px 20px; border-radius: 8px; background: transparent; border: none; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); color: rgba(255, 255, 255, 0.9); font-weight: 500;">
            ...
            <li class="nav-item" style="margin: 6px 16px;">
                <a class="nav-link" href="<?php echo e(route('analytics.index')); ?>" style="padding: 16px 20px; border-radius: 8px; background: transparent; border: none; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); color: rgba(255, 255, 255, 0.9); font-weight: 500;">
            ...
            <li class="nav-item active" style="margin: 6px 16px;">
                <a class="nav-link" href="<?php echo e(route('settings.alerts')); ?>" style="padding: 16px 20px; border-radius: 8px; background: rgba(255, 255, 255, 0.05); border: none; backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); box-shadow: none;">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div id="recipientsContainer">
                            <?php if(count($settings->recipients) > 0): ?>
                                <?php $__currentLoopData = $settings->recipients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $recipient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="recipient-row" data-index="<?php echo e($index); ?>">
                                        <div class="row">
                                             <div class="col-md-4">
                                                 <label class="form-label">Name</label>
                                                 <input type="text" class="form-control" name="recipients[<?php echo e($index); ?>][name]" 
                                                        value="<?php echo e($recipient['name'] ?? ''); ?>" readonly required placeholder="Enter recipient name">
                                             </div>
                                             <div class="col-md-3">
                                                 <label class="form-label">Phone</label>
                                                 <input type="text" class="form-control" name="recipients[<?php echo e($index); ?>][phone]" 
                                                        value="<?php echo e($recipient['phone'] ?? ''); ?>" readonly placeholder="Enter phone number">
                                             </div>
                                             <div class="col-md-3">
                                                 ...
                                                 <input type="hidden" name="recipients[<?php echo e($index); ?>][role]" value="admin">
                                             </div>
                        ...
                        <div id="noRecipients" class="text-center py-4 <?php echo e(count($settings->recipients) > 0 ? 'd-none' : ''); ?>">
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $recentLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr style="border-bottom: 1px solid #f1f5f9; transition: all 0.3s ease;" onmouseover="this.style.backgroundColor='#f8fafc'" onmouseout="this.style.backgroundColor='white'">
                                            <td style="border: none; padding: 1rem 1.5rem; vertical-align: middle;">
                                                <span style="background: linear-gradient(135deg, #3b82f6, #1d4ed8); color: white; padding: 6px 12px; border-radius: 20px; font-weight: 600; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.5px; box-shadow: 0 2px 8px rgba(59, 130, 246, 0.3);"><?php echo e($log->device_id); ?></span>
                                            </td>
                                            <td style="border: none; padding: 1rem 1.5rem; vertical-align: middle; font-weight: 600; color: #374151;"><?php echo e($log->barangay); ?></td>
                                            <td style="border: none; padding: 1rem 1.5rem; vertical-align: middle;">
                                                <span style="background: linear-gradient(135deg, #f59e0b, #d97706); color: white; padding: 6px 12px; border-radius: 20px; font-weight: 700; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.5px; box-shadow: 0 2px 8px rgba(245, 158, 11, 0.3);">
                                                    <?php echo e(ucfirst(str_replace('_', ' ', $log->alert_type))); ?>

                                                </span>
                                            </td>
                                            <td style="border: none; padding: 1rem 1.5rem; vertical-align: middle; color: #64748b; font-size: 0.875rem; line-height: 1.5;"><?php echo e(Str::limit($log->message, 50)); ?></td>
                                            <td style="border: none; padding: 1rem 1.5rem; vertical-align: middle;">
                                                <div style="display: flex; flex-direction: column; align-items: flex-start;">
                                                    <span style="color: #374151; font-weight: 600; font-size: 0.875rem;"><?php echo e($log->created_at->format('M d, Y')); ?></span>
                                                    <span style="color: #64748b; font-size: 0.75rem;"><?php echo e($log->created_at->format('g:i:s A')); ?></span>
                                                </div>
                                            </td>
                                        </tr>
                        ...
                        <div style="background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); border-top: 1px solid #e2e8f0; padding: 1rem 1.5rem; text-align: center;">
                            <div style="display: flex; align-items: center; justify-content: center; gap: 1rem; color: #64748b; font-size: 0.875rem;">
                                <div style="display: flex; align-items: center; gap: 0.5rem;">
                                    ...
                                    <span id="logs-count" style="font-weight: 600; color: #374151;"><?php echo e($recentLogs->count()); ?></span>
                                ...
                                <div style="display: flex; align-items: center; gap: 0.5rem;">
                                    ...
                                    <span id="last-update" style="font-weight: 600; color: #374151;"><?php echo e(now()->format('g:i:s A')); ?></span>
                                </div>
                            </div>
                        </div>
        ...
        <!-- Web Push Notifications -->
        <script src="<?php echo e(asset('js/webpush.js')); ?>"></script>
    <script>
        let recipientIndex = <?php echo e(count($settings->recipients)); ?>;
        ...
        function saveRecipientsToDatabase() {
            ...
            // Send to backend
            fetch('<?php echo e(route("settings.alerts.save")); ?>', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
<?php /**PATH C:\laragon\www\E-Grid-Monitoring-System\resources\views/alert-settings.blade.php ENDPATH**/ ?>