    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f172a 100%); box-shadow: 0 8px 32px rgba(0, 0, 0, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.1); backdrop-filter: blur(20px); -webkit-backdrop-filter: blur(20px);">
            ...
            <li class="nav-item active" style="margin: 6px 16px;">
                <a class="nav-link" href="<?php echo e(route('devices.index')); ?>" style="padding: 16px 20px; border-radius: 8px; background: rgba(255, 255, 255, 0.05); border: none; backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px); transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); box-shadow: none;">
            ...
            <li class="nav-item" style="margin: 6px 16px;">
                <a class="nav-link" href="<?php echo e(route('settings.alerts')); ?>" style="padding: 16px 20px; border-radius: 8px; background: transparent; border: none; transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1); color: rgba(255, 255, 255, 0.9); font-weight: 500;">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-5">
                        ...
                        <div class="d-flex align-items-center" style="gap: 20px;">
                            <div class="d-flex align-items-center" style="background: rgba(16, 185, 129, 0.1); padding: 8px 16px; border-radius: 20px; border: 1px solid rgba(16, 185, 129, 0.2);">
                                ...
                                <span style="color: #059669; font-weight: 600; font-size: 0.875rem;"><?php echo e($devices->count()); ?> Devices</span>
                            </div>
                            <a href="<?php echo e(route('devices.create')); ?>" class="btn" style="background: linear-gradient(135deg, #3b82f6, #1d4ed8); color: white; border: none; padding: 12px 24px; border-radius: 8px; font-weight: 600; box-shadow: 0 4px 12px rgba(59, 130, 246, 0.3); text-decoration: none; transition: all 0.3s ease;">
...
<?php /**PATH C:\laragon\www\E-Grid-Monitoring-System\resources\views/index.blade.php ENDPATH**/ ?>