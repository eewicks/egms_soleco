                ...
                <div class="container-fluid" style="background: transparent; min-height: 100vh; padding: 2rem 1.5rem;">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-5">
                        <div>
                            ...
                            <p class="text-muted mb-0" style="font-size: 1rem; color: rgba(255, 255, 255, 0.8);">Update the information for device: <?php echo e($device->device_id); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="card" style="background: linear-gradient(135deg, #ffffff 0%, #f8fafc 100%); border: none; border-radius: 16px; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.08); overflow: hidden; max-width: 800px; margin: 0 auto;">
                        ...
                        <div class="card-body" style="padding: 2rem;">
                            ...
                            <form action="<?php echo e(route('devices.update', $device->id)); ?>" method="POST" id="updateDeviceForm">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="text" name="household_name" value="<?php echo e($device->household_name); ?>" class="form-control" required 
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="text" name="device_id" value="<?php echo e($device->device_id); ?>" class="form-control" required 
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="text" name="barangay" value="<?php echo e($device->barangay); ?>" class="form-control" required
                                               style="border: 2px solid #e5e7eb; border-radius: 8px; padding: 12px 16px; font-size: 1rem; transition: all 0.3s ease; max-width: 400px;"
                                               onfocus="this.style.borderColor='#3b82f6'; this.style.boxShadow='0 0 0 3px rgba(59, 130, 246, 0.1)'"
                                               onblur="this.style.borderColor='#e5e7eb'; this.style.boxShadow='none'"
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="text" name="contact_number" id="contact_number" value="<?php echo e($device->contact_number); ?>" class="form-control" 
                                               style="border: 2px solid #e5e7eb; border-radius: 8px; padding: 12px 16px; font-size: 1rem; transition: all 0.3s ease; max-width: 400px;"
                                               onfocus="this.style.borderColor='#3b82f6'; this.style.boxShadow='0 0 0 3px rgba(59, 130, 246, 0.1)'"
                                               onblur="this.style.borderColor='#e5e7eb'; this.style.boxShadow='none'"
...
<?php /**PATH C:\laragon\www\E-Grid-Monitoring-System\resources\views/edit.blade.php ENDPATH**/ ?>